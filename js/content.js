    ...
    /* ================================================================== */
    {
      ...
      sections: [
        ...
        },
        {
          ...
          intro: 'Every question must be answered correctly before the case can be stamped. Wrong picks are ruled out — work the rest yourself; the reasoning appears once you commit to the right answer.',
          questions: [
            ...
            { id: 'm1q2', q: 'A pathogen has R0 = 5. At the threshold where the epidemic can no longer grow, what fraction of the population is still SUSCEPTIBLE?', opts: ['20%', '40%', '60%', '80%'], correct: 0, why: 'Threshold susceptible fraction s* = 1/R0 = 1/5 = 20%. The immune fraction is the complement: 1 − 1/R0 = 80% must be immune. Herd-immunity percentages quoted in the news are exactly 1 − 1/R0 — read carefully whether a headline means susceptible or immune.' },
    ...
    /* ================================================================== */
    {
      ...
      sections: [
        ...
        },
        {
          ...
          tasks: [
            'Write the modified equations for an SEIR + F system, where infectious bodies (state F, "funeral") remain infectious for an average of 2 days before safe burial.',
      ...
      sections: [
        {
          ...
          blocks: [
            ...
            { t: 'p', md: 'Two traps. First, <span class="term">exposed ≠ infectious</span>: E means "infected, not yet transmitting" — defined by <strong>transmission status</strong>, never by symptoms — for measles, patients become infectious ~4 days <em>before</em> the rash, so the E→I transition happens mid-incubation. Second, <span class="term">latent ≠ incubation</span>: latency is time-to-infectiousness; incubation is time-to-symptoms. They differ for almost every pathogen — by ~4 days for measles.' }
          ]
        },
        {
      ...
      sections: [
        {
          ...
          blocks: [
            ...
            { t: 'p', md: '<span class="term">Prevalence</span> = E + I (everyone currently infected), and <span class="term">cumulative incidence</span> is the running total of incidence — the curve that only ever rises. The data (MoH Malaysia open data): daily cases from 25 Jan 2020, peaking at 235/day in late March (the year\'s high of 277/day came in June), 8,639 cumulative by 30 June.' },
        ...
        },
        {
          ...
          predict: {
            q: 'With R0 = 4 and a mean generation interval of ~8 days (latent 5 d plus about half of the 6-day infectious period), roughly when does modelled incidence cross 100 cases/day, starting from 20 cases on 28 Feb?',
            opts: ['within ~1 week (early March)', 'around mid–late March', 'around end of April', 'never — it stays below 100'], correct: 1,
            why: 'With a 5-day latent stage the SEIR early growth rate is slower than the SIR shortcut r = γ(R0−1) = 0.5/day — here ≈ 0.18/day (doubling ~3.8 days), because newly exposed people are not yet infectious. From a seed of 20, reaching 100/day is ~2.3 doublings ≈ 9 days, so the crossing lands mid-to-late March — and the real data peaked 235/day at end-March: the model window 28 Feb–18 Mar sits on the steep part.'
          },
        ...
        },
        {
          ...
          modelAnswer: '1) Flu: r = (1/3)(0.5) ≈ 0.167/day. COVID course model: r = (1/6)(3) = 0.5/day. COVID grows ~3× faster per day DESPITE both being "respiratory" — R0 = 4 vs 1.5 dominates.\n2) Doubling: flu ln2/0.167 ≈ 4.2 days; COVID ln2/0.5 ≈ 1.4 days.\n3) Flu: slower take-off, later peak, and much smaller attack rate (R0 1.5 → final size ~58% susceptible-depletion limit vs COVID R0 4 → ~98% in an unmitigated SEIR). Lower peak daily incidence spread over longer time.\n4) "Wait and see" costs more with the faster-growing, higher-R0 virus (COVID here): a week of delay is ~5 doublings (≈33×) for the course COVID model versus ~1.7 doublings (≈3×) for flu — and COVID\'s final size is far larger without action.',
    ...
    /* ================================================================== */
    {
      ...
      sections: [
        ...
        },
        {
          ...
          intro: 'The real Malaysian daily cases, 28 Feb – 18 Mar (20 daily bars — 2020 was a leap year). Your two free parameters: R0 and the seed I(0) — exactly the course\'s setup. The readout shows your SSQ and NLL live.',
          predict: {
    ...
    /* ================================================================== */
    {
      ...
      sections: [
        ...
        },
        {
          ...
          predict: {
            q: 'At the preset parameters (lifespan 14 d, extrinsic incubation 10 d): you can halve the bite rate (a) OR halve adult mosquito lifespan (double μV). Which cuts R0 more?',
            ...
            why: 'a enters squared (two bites per generation), but at these presets doubling μV multiplies R0 by √(0.5·e^(−μV·n)) ≈ 0.50 — a shade better than the √0.5 ≈ 0.71 of halving a — because μV appears twice: in the denominator AND the survival exponential e^(−μV·n). (At longer lifespans the race tightens — halving a can win.) Field programmes combine levers precisely because no single lever reaches the 36-fold m reduction that R0 = 6 demands.'
          },
    ...
    /* ================================================================== */
    {
      ...
      sections: [
        ...
        },
        {
          ...
          controls: 'Reproduce the calibration: set the MCO to 18 March (phase 2 follows automatically 14 days later, matching the course\'s 1 April), then tune e₁ and e₂ until your NLL approaches the course\'s fitted 633.1 (revealed on request). Then run the counterfactual: shift the MCO one week later. Watch the total.'
        },
        {
          id: 'm7-s3', kind: 'quiz', title: 'Checkpoint — the policy seminar',
          questions: [
            { id: 'm7q1', q: 'Phase 1 (e₁ = 0.73) left Reff ≈ 1.42 > 1. What did Malaysian case data do between 18 and 31 March?', opts: ['immediately declined', 'kept rising, at a slower exponential rate', 'flatlined at zero', 'rose at the same rate as before'], correct: 1, why: 'Reff > 1 means growth continues — only the exponent shrinks (r scales by (1−e)). Cases rose to the 26 March peak and turned down in the final days of March — earlier than the calibrated model expects; the fitted model attributes the sustained decline to phase 2 pushing Reff below 1. "Intervention" ≠ "instant reversal" — this is the single most miscommunicated fact in outbreak politics.' },
            ...
            { id: 'm7q3', q: 'The counterfactual "MCO one week later" shows total cases ballooning. The cleanest one-line explanation:', opts: ['more people were infectious at peak', 'one extra week at Reff ≈ 5.24 is ~7 doublings of the pre-intervention base — the peak you must climb is exponentially higher', 'phase 2 would have failed', 'hospitals filled up'], correct: 1, why: 'Pre-intervention growth (SIR shortcut) r = γ(R0−1) = (1/6)(4.235) ≈ 0.71/day → doubling ~1 day → a week ≈ 7 doublings ≈ 140× the seed the intervention must contain. (The 5-day latent stage slows the true rate — the direction of the lesson is unchanged.) Timing compounds; this is why "two weeks to flatten" was never a slogan but arithmetic.' },
        ...
        },
        {
          ...
          points: [
            ...
            'e must EXCEED 1 − 1/R0 to force decline: phase 1\'s 0.73 against R0 5.24 was never enough — phase 2\'s 0.87 was.',
      ...
      sections: [
        ...
        },
        {
          ...
          questions: [
            ...
            { id: 'm8q5', q: 'Which of these is NOT one of the course\'s models, but IS defensibly equivalent to one of them, structurally?', opts: ['a chickenpox model with lifelong immunity after infection (SEIR)', 'an aftershock model where each earthquake triggers exactly one successor, forever', 'an information-rumour model S→I→R on social media (same grammar, different "pathogen")', 'a stock-market model'], correct: 2, why: 'Rumour/information spreading is literally SIR with "susceptible = hasn\'t heard it, infectious = sharing it". The grammar\'s portability is the entire point of this register: learn the flows once, recognise them anywhere — from measles to misinformation.' }
          ]
        },
        {
