      ...
      sections: [
        {
          ...
          blocks: [
            ...
            { t: 'p', md: 'Two traps. First, <span class="term">exposed ≠ infectious</span>: E means "infected, not yet transmitting" — for measles the child in E is already febrile? No: pre-rash measles patients are actually infectious <em>before</em> the rash, which is why E must be defined by <strong>transmission status</strong>, not symptoms. Second, <span class="term">latent ≠ incubation</span>: latency is time-to-infectiousness; incubation is time-to-symptoms. They differ for almost every pathogen (they differ by ~4 days for measles).' }
          ]
        },
        {
      ...
      sections: [
        ...
        },
        {
          ...
          predict: {
            ...
            why: 'Growth r = γ(R0−1) = (3)/6 = 0.5/day is fast, but from a seed of 20 reaching 100 is barely one doubling — the visible climb to hundreds takes ~2–4 weeks. The real data peaked 235/day at end-March: the model window 28 Feb–18 Mar sits on the steep part.'
          },
